...
public class MeshCombineUtility
{
    ...
    public void AddMeshInstance(MeshInstance instance)
    {
		...
		foreach(Vector3 newVec in instance.mesh.vertices)
		{
			_vertices.Add (instance.transform.MultiplyPoint(newVec));
		}

		foreach(Vector3 normal in instance.mesh.normals)
		{
			_normals.Add (instance.transform.inverse.transpose.MultiplyVector(normal).normalized);
		}
